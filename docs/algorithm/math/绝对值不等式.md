...
*   若 $n$ 为奇数。  
    ...
    $$
    \begin{align*}
    \sum^n_{i=1} |a_1-a_\frac n 2| &= \underbrace{(a_n-a_\frac n 2)+(a_{n-1}-a_\frac n 2)+...}_{共\frac n 2-1项} +(a_\frac n 2-a_\frac n 2)+\underbrace{...+(a_\frac n 2-a_2)+(a_\frac n 2-a_1)}_{共\frac n 2-1项} \\
